...
const navigationMenuTriggerStylePrenium = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm text-[#F9CE00] font-medium transition-colors hover:bg-[#F9CE00]/15 hover:text-[#F9CE00]-foreground focus:bg-[#F9CE00]/15 focus:text-[#F9CE00]-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50"
)
