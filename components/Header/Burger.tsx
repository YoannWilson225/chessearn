        ...
        <div className="pr-2 pt-2">
            <button onClick={openLeftNavigation}>
                <svg width="38" height="54" className='' viewBox="0 0 38 54" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <line x1="1" y1="16" x2="23" y2="16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                    <line x1="1" y1="26" x2="28" y2="26" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                    <line x1="1" y1="36" x2="23.5" y2="36" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                </svg>
            </button>
            {isLeftNavOpen && (
